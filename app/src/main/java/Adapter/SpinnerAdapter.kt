...
import kotlinx.android.synthetic.main.dedline_group.view.*
...
class ExpandetAdapter(var titleList: List<String>, var map: HashMap<String, ArrayList<String>>) :
    ...
    override fun getGroupView(
        ...
        if (convertView == null){
            groupItemView = LayoutInflater.from(parent?.context).inflate(R.layout.item_spinner, parent, false)
        }else{
    ...
    override fun getChildView(
        ...
        if (convertView == null){
            childItemView = LayoutInflater.from(parent?.context).inflate(R.layout.dedline_group, parent, false)
        }else{
